...
{
    public partial class Form_Sec_Proficiency : System.Web.UI.Page
    {
        TextBox[] tbWeight, tbRating, tbWeightedScore;
        string empFormID, empType, process, field = "Section1CWR"; // have to adjust what field based on emptype 
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            tbWeight = new TextBox[] { weight1, weight2, weight3, weight4, weight5, weight6, weight7, weight8 };
            tbRating = new TextBox[] { rating1, rating2, rating3, rating4, rating5, rating6, rating7, rating8 };
            tbWeightedScore = new TextBox[] { score1, score2, score3, score4, score5, score6, score7, score8 };
